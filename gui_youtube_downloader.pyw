...
def single_video_download(): #single video download method
    ...
    download_status.config(text=f"downloading {youtube_object.title}...")
    ...
    try:
        ...
        download_status.config(text=f"there was an error while downloading {youtube_object.title}")
        download_status.update()
    print(f"{youtube_object.title} downloaded successfully\n")
    download_status.config(text=f"downloaded {youtube_object.title} successfully!")
    download_status.update()
